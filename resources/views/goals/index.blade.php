...
<div class="container">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
        <h2 class="mb-0">Tujuan Tabungan</h2>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column flex-sm-row gap-1">
                                                <a href="{{ route('goals.edit', $g->id) }}" class="btn btn-warning btn-sm w-100 w-sm-auto text-dark">
                                                    <i class="bi bi-pencil-square"></i> Edit
                                                </a>
                                                <form action="{{ route('goals.destroy', $g->id) }}" method="POST" class="d-inline w-100 w-sm-auto">
                                                    @csrf @method('DELETE')
                                                    <button type="button" class="btn btn-danger btn-sm btn-delete w-100">
